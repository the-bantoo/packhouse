...
def get_columns(filters):
	...
	columns = [
		{"label": _("Delivery Date"), "fieldname": "delivery_date", "fieldtype": "Date", "width": 120},
			{"label": _("Delay (Days)"), "fieldname": "delay", "fieldtype": "Data", "width": 100},
			{
	...
	if not filters.get("group_by_so"):
		...
		columns.append({"label": _("Status"), "fieldname": "status", "fieldtype": "Data", "width": 90})
		columns.append(
			{
				"label": _("Item Code"),
				"fieldname": "item_code",
		...
		columns.append(
			{"label": _("Description"), "fieldname": "description", "fieldtype": "Small Text", "width": 150}
		)
